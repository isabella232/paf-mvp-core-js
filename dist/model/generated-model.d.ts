 ...
 */
export declare type GetIdPrefsRequest = MessageBase;
/**
 ...
 */
export declare type GetIdPrefsResponse = MessageBase & {
 ...
 */
export declare type GetNewIdRequest = MessageBase;
/**
 * GET /v1/new-id response
 */
export declare type GetNewIdResponse = MessageBase & {
    body: {
 ...
 */
export declare type PostIdPrefsRequest = MessageBase & {
    body: IdAndPreferences;
};
/**
 * POST /v1/id-prefs response
 */
export declare type PostIdPrefsResponse = MessageBase & {
    body: IdAndPreferences;
};
/**
 * ** Please ignore **
